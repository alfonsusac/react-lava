...
export function UesClientClientPage(props: {
  ...
  useEffect(() => {
    hl_init.current?.animate([{ opacity: 1 }, { opacity: 0 }], { duration: unit(3) })
    hl_comp.current?.animate([{ opacity: 1 }, { opacity: 0 }], { duration: unit(3), delay: unit(1) })
    hl_getr.current?.animate([{ opacity: 1 }, { opacity: 0 }], { duration: unit(3), delay: unit(2) })
    hl_liks.current?.animate([{ opacity: 1 }, { opacity: 0 }], { duration: unit(3), delay: unit(3) })
  }, [])
              ...
              <div className="flex flex-col items-center justify-center h-full">
                ...
                <div className="flex gap-2 mt-8">
                  <Button
                    onClick={() => {
                      setLikes(likes + 1)
                      hl_ocl1.current?.animate([{ opacity: 1 }, { opacity: 0 }], { duration: unit(3) })
                      hl_setr.current?.animate([{ opacity: 1 }, { opacity: 0 }], { duration: unit(3), delay: unit(1) })
                      hl_comp.current?.animate([{ opacity: 1 }, { opacity: 0 }], { duration: unit(3), delay: unit(2) })
                      hl_getr.current?.animate([{ opacity: 1 }, { opacity: 0 }], { duration: unit(3), delay: unit(3) })
                      hl_liks.current?.animate([{ opacity: 1 }, { opacity: 0 }], { duration: unit(3), delay: unit(4) })
                    }}>
                  ...
                  <Button
                    ...
                    onClick={() => {
                      setLikes(0)
                      hl_ocl2.current?.animate([{ opacity: 1 }, { opacity: 0 }], { duration: unit(3) })
                      hl_setr.current?.animate([{ opacity: 1 }, { opacity: 0 }], { duration: unit(3), delay: unit(1) })
                      hl_comp.current?.animate([{ opacity: 1 }, { opacity: 0 }], { duration: unit(3), delay: unit(2) })
                      hl_getr.current?.animate([{ opacity: 1 }, { opacity: 0 }], { duration: unit(3), delay: unit(3) })
                      hl_liks.current?.animate([{ opacity: 1 }, { opacity: 0 }], { duration: unit(3), delay: unit(4) })
